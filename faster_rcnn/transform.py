...
class GeneralizedRCNNTransform(nn.Module):
    ...
    model. This doesn't contain any sort of "Parameters" to be updated.

    `forward` method Input :
        - List[Tensor[NUM_IMAGES, CHANNEL, HEIGHT, WIDTH]]
        - Optional
                [List
                    [
                    Dict[
    ...
    Only performas the transformation mentioned below :
